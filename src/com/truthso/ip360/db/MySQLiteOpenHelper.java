	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		if(oldVersion==1){
			...
			try {
				...
				db.execSQL("INSERT INTO updownloadlog (_id, sourceid, uploadfilepath,downloadurl,filename,filesize,position,downorupload,objectkey,llsize,status,fileurlformatname ,userId ,dataType,remark) SELECT (_id, sourceid, uploadfilepath,downloadurl,filename,filesize,position,downorupload,objectkey,llsize,status,fileurlformatname ,userId ,dataType,remark) FROM updownloadlog_temp");
