...
public class ReBindPhoNumActivity extends BaseActivity implements
	...
	public void initView() {
		...
		mSpannableStringBuilder.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.jiuhong)), 0, 5, Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
		mSpannableStringBuilder.setSpan(new ForegroundColorSpan(getResources().getColor(R.color.black)), 5, 14, Spannable.SPAN_EXCLUSIVE_INCLUSIVE);
