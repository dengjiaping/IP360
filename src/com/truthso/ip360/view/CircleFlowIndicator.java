...
public class CircleFlowIndicator extends View implements FlowIndicator,
	...
	public CircleFlowIndicator(Context context, AttributeSet attrs) {
		...
		int inactiveDefaultColor = 0xFFE6828E;
		// Get a custom inactive color if there is one
		...
		// Retrieve the radius
		radius = a.getDimension(R.styleable.CircleFlowIndicator_radiuss, 4.0f);
		...
		mCentered = a.getBoolean(R.styleable.CircleFlowIndicator_centereed, false);
